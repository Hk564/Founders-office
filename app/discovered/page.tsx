...
export const metadata = {
  title: 'Discoveries — foundersoffice.xyz',
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-6 py-24">
        ...
        {discoveries && discoveries.length > 0 ? (
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">
                      {platformEmoji[discovery.platform?.toLowerCase()] ?? '🌐'}
                    </span>
                    <div>
                      <p className="font-semibold text-[#09090B] capitalize">{discovery.platform}</p>
                      {discovery.query && (
                        <p className="text-sm text-[#7C3AED] mt-0.5">&ldquo;{discovery.query}&rdquo;</p>
                      )}
                    </div>
                  </div>
          ...
          <div className="text-center py-24 rounded-2xl border-2 border-dashed border-[#E4E4E7]">
            ...
            <p className="text-[#09090B] font-semibold text-lg mb-2">Not yet — but the engine is running.</p>
